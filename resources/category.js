class CategoryResource {
    ...
    createCategory(category){
        return this.shoploClient.create(CategoryResource.getCategoryPath(null), { category });
    }

    updateCategory(id, category){
        return this.shoploClient.update(CategoryResource.getCategoryPath(id), { category });
    }
